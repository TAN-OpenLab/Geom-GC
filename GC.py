...
class GarbledCircuit:
    ...
    def _gen_garbled_values(self):
        ...
        for wire in self.wires:
            garbled_value0 = random.randint(-2**63,2**63-1)
            garbled_value1 = random.randint(-2**63,2**63-1)

            garbled_value0 = pack('q',garbled_value0)
            garbled_value1 = pack('q',garbled_value1)
